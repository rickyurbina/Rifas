<?php
    ...
    class BoletosModel{
        ...
        public static function mdlAgregarBoleto($datosModel){
            $statement = Conexion::conectar() -> prepare("INSERT INTO `boletos` VALUES (NULL,:idSorteo,:nombre,:telefono,:estado,:email,:noBoleto,:status,:fecha, :fechaPago);");
        ...
        public static function mdlActualizarBoleto($datosModel) {
            $statement = Conexion::conectar() -> prepare("UPDATE `boletos` SET `nombre`= :nombre, `telefono` = :telefono, `email` = :email, `estado` = :estado, `status` = :s WHERE `noBoleto` = :noBoleto AND `idSorteo` = :idSorteo;");
       ...
       public static function mdlObtenerBoletosVendidos(){
        ...
        public static function mdlCompletarBoleto($idBoleto){
            $statement = Conexion::conectar() -> prepare("UPDATE `boletos` SET `status`='P', fechaPago=current_date() WHERE `idBoleto` = :id;");
