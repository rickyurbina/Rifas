    ...
    <div class="main-navbar">
      ...
      <div id="mainnav">
        <ul class="nav-menu custom-scrollbar">
          <li class="dropdown"><a class="nav-link menu-title link-nav" href="knowledgebase.html"><span>Knowledgebase</span></a></li>
          <li><a class="nav-link" href="inicio.php?action=agregarBoleto"><i class="fas fa-ticket-alt mr-2"></i><span>Vender boleto</span></a></li>
          <li><a class="nav-link" href="inicio.php?action=uptBoleto"><i class="fas fa-ticket-alt mr-2"></i><span>Editar boleto</span></a></li>
