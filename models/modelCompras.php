...
class ComprasModel {
  ...
  public static function mdlAgregarCompra($datosModel) {
    ...
    $statement = Conexion::conectar() -> prepare("INSERT INTO `boletos` VALUES (NULL, :idSorteo, :nombre, :telefono,:estado, :email, :noBoleto, 'N',:fecha, :fecha, :horaApartado, '00:00:00');");
  ...
  public static function mdlConfirmarCompra($datosModel) {
    $statement = Conexion::conectar() -> prepare("INSERT INTO `boletos` VALUES(null, :idSorteo, :nombre, :telefono, :estado, :email, :noBoleto, 'L', :fecha, :fechaPago, :horaApartado, :horaPagado );");
